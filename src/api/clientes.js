...
//crear un nuevo cliente,al crear un nuevo cliente le damos al boton de crear y nos redirecciona a la pagina principal, y veremos este nuevo cliente, y si recargamos la api que hicimos en json-server aparecera este nuevo registro
